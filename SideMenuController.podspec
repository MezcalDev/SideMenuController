Pod::Spec.new do |s|
  ...
  s.homepage = 'https://github.com/AylaNetworks/SideMenuController_Public'
  s.social_media_url = 'http://twitter.com/teodorpatras'
  s.authors = { 'Teodor Patraș' => 'me@teodorpatras.com' }
  s.source = { :git => 'https://github.com/AylaNetworks/SideMenuController_Public.git', :tag => s.version }
